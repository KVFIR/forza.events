...
- Настроена аутентификация через Discord (требует дополнительной настройки)
- Реализовано создание и отображение событий
- Временно отключена проверка аутентификации для создания событий

## Следующие шаги

1. Завершить интеграцию аутентификации Discord
2. Добавить редактирование и удаление событий
3. Улучшить UI/UX фронтенда
4. Добавить валидацию данных на бэкенде и фронтенде
5. Реализовать систему участия в событиях
