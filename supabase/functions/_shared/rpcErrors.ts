...
const RPC_EXCEPTION_PATTERN =
  /\b(RESULTS_ALREADY_SUBMITTED|PUBLISH_IN_PROGRESS|FORBIDDEN|EVENT_NOT_FOUND|BAD_REQUEST|NOT_DRAFT|GROUPS_MAXED|WAITLIST_EMPTY|LOBBY_NOT_FULL|EVENT_FULL|LEADER_CANNOT_LEAVE|LEADER_ALREADY_CONVOY_LEADER|INVALID_GROUP_INDEX)\b/;
...
export function responseForRpcException(
  ...
  const status =
    code === API_ERROR_CODES.RESULTS_ALREADY_SUBMITTED || code === API_ERROR_CODES.EVENT_FULL
      ? 409
