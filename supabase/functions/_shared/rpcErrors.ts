...
const RPC_EXCEPTION_PATTERN =
  /\b(RESULTS_ALREADY_SUBMITTED|PUBLISH_IN_PROGRESS|FORBIDDEN|EVENT_NOT_FOUND|BAD_REQUEST|NOT_DRAFT|GROUPS_MAXED|WAITLIST_EMPTY|LOBBY_NOT_FULL|EVENT_FULL|LEADER_CANNOT_LEAVE|LEADER_CANNOT_MOVE|LEADER_ALREADY_CONVOY_LEADER|INVALID_GROUP_INDEX|REGISTRATION_CLOSED|REGISTRATION_AFTER_START)\b/;
...
const RPC_CODE_TO_API: Record<string, ApiErrorCode> = {
  ...
  LEADER_CANNOT_MOVE: API_ERROR_CODES.LEADER_CANNOT_MOVE,
