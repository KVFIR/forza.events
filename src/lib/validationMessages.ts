...
const VALIDATION_I18N_KEYS: Record<ValidationCode, string> = {
  ...
  RANKED_TYPE_NOT_ALLOWED: 'validation.rankedTypeNotAllowed',
  RANKED_GUILD_REQUIRED: 'validation.rankedGuildRequired',
  RANKED_GUILD_NOT_ALLOWED: 'validation.rankedGuildNotAllowed',
  RANKED_LOCKED: 'validation.rankedLocked',
